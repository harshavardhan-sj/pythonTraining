...
from python_file_task import Task_02



#File path of CSV file operation task.
csv_path = os.path.join("C:/","Python27","csv_task.py")

#File path of Gmail Automation task.
gmail_path = os.path.join("C:/","Python27","Gmail_automation_1_2.py")

#File path of Files and directories operation task.
file_path = os.path.join("C:/","Python27","files_dir_task.py")

#File path of Excel file operation task.
excel_path = os.path.join("C:/","Python27","excel_file_task.py")
