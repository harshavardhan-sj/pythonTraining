...
class Task_02:
    ...
    def file_folder_count(self):
        """
            Method to Get all files count and directories
    ...
    def duplicate_files(self):
        ...
        def generate_md5(fname, chunk_size=1024):
            ...
            """
                ...
                Method which takes a file name and returns md5
        ...
        if __name__ == "__main__":
            ...
            print("checkout in path{}".format("C","Python27","duplicates.csv"))
            print("\n")
    ...
    def capitalise_first_letter(self):
        """
            Method to replace all the word with first
    ...
    def remove_string(self):
        """
            Method to remove the given string in the
