...
path = os.path.join("home","padmini","Training","pythonTraining",\
                    "Helper","CSV_Task","100 Sales Records.csv")
...
class Task_csv:
    ...
    def sort_region(self):
        """
            To Read the csv file and print all the Region
    ...
    def online_sale_channel(self):
        """
            To List all the country name where the
    ...
    def asia_region_items(self):
        """
            To Write all the Asia region items into the new csv file.
    ...
    def valid_ship_date(self):
        """
            To  Write all the items into a new csv for the items having
            valid ship date.
